    ...
    <form onSubmit={handleSubmit}>
      <div className='border-b pb-12'>
        <div className='cols-span-3'>
          ...
          <div className='mt-3'>
            <input id="name" name="name" placeholder="Nome" className='block rounded-md w-full border px-3 py-1.5' onChange={handleChange} />
          </div>
        </div>
      ...
      <div className='mt-4 flex justify-end'>
        <button type="submit" className='rounded-md py-2 px-3 text-semibold bg-sky-700 text-white hover:bg-sky-900'>Cadastrar</button>
      </div>
    </form>
  );
};
